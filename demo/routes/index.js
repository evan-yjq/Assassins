...
router.get('/get_test_result', function (req, res) {
    var option = req.query.setting+' '+req.query.serverName+' '+req.query.signUser+' '+req.query.apiKey+' '+req.query.cnt+' ';
    cp.exec('python TestExtension.py '+option, function(err, stdout, stderr){
